...
namespace VideStore.Persistence.Migrations
{
    ...
    [Migration("20250204193223_AddOrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideStore.Domain.Entities.OrderEntities.Order", b =>
                {
                    b.OwnsOne("VideStore.Domain.Entities.OrderEntities.Address", "ShippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("VideStore.Domain.Entities.OrderEntities.OrderItem", b =>
                {
                    b.HasOne("VideStore.Domain.Entities.OrderEntities.Order", null)
                        .WithMany("Items")
                        .HasForeignKey("OrderId");
                });
